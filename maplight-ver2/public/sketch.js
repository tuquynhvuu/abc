...
let blocks = [
  {
...

   {
    ...
    corners: [
      ...
      { lat: 31.149816, lon: 121.482342 }, // bottom left
      { lat: 31.150045, lon: 121.483747 }, // bottom right
      { lat: 31.150913, lon: 121.483286 }  // top right
    ],
    trigger: { lat: 31.149999, lon: 121.483018},
    triggerRadius: 0.00018,
    color: null, // starts white
        cooldownEnd: 0
...

{
  name: "campus_east2",
  corners:[
    {lat:31.148365, lon:121.478792}, //top left
